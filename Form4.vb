Public Class Form4
    ...
    Private Sub Form4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'MRdatabaseDataSet8.mainfields' table. You can move, or remove it, as needed.
        Me.MainfieldsTableAdapter3.Fill(Me.MRdatabaseDataSet8.mainfields)
        TextBox2.Text = Today()
