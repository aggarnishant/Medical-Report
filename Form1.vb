...
Public Class Form1
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        OpenFileDialog1.Filter = "Picture Files (*.*) | *.bmp;*.png;*.gif;*.jpeg;*.jpg"
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        If TextBox1.Text = "" Then
            TextBox1.Text = InputBox("Please Enter Patient Name")
        End If
        If TextBox2.Text = "" Then
            TextBox2.Text = InputBox("Please Enter Patient Age")
        End If
        If TextBox3.Text = "" Then
            TextBox3.Text = InputBox("Please Enter Patient's Complaint")
        End If
        If ComboBox1.Text = "" Then
            ComboBox1.Text = InputBox("Enter Patient Age Value (YEARS/MONTHS/DAYS)")
        End If
        If ComboBox2.Text = "" Then
            ComboBox2.Text = InputBox("Select 'Foreign Body' Status")
        End If
        If ComboBox3.Text = "" Then
            ComboBox3.Text = InputBox("Select 'Lingual Tonsils' Status")
        End If
        If ComboBox4.Text = "" Then
            ComboBox4.Text = InputBox("Select 'Vallecula' Status")
        End If
        If ComboBox5.Text = "" Then
            ComboBox5.Text = InputBox("Select 'Vocal Cord True' Status")
        End If
        If ComboBox6.Text = "" Then
            ComboBox6.Text = InputBox("Select 'Vocal Cord False' Status")
        End If
        If ComboBox7.Text = "" Then
            ComboBox7.Text = InputBox("Select 'Vocal Cord Mobility' Status")
        End If
        If ComboBox8.Text = "" Then
            ComboBox8.Text = InputBox("Select 'Phonatory Gap' Status")
        End If
        If ComboBox9.Text = "" Then
            ComboBox9.Text = InputBox("Select 'Arytenoids' Status")
        End If
        If ComboBox10.Text = "" Then
            ComboBox10.Text = InputBox("Select 'Lateral Pharyngeal Wall' Status")
        End If
        If ComboBox11.Text = "" Then
            ComboBox11.Text = InputBox("Select 'Post Cricoid Space' Status")
        End If
        If ComboBox12.Text = "" Then
            ComboBox12.Text = InputBox("Select 'Pyriform Sinus' Status")
        End If
        If ComboBox13.Text = "" Then
            ComboBox13.Text = InputBox("Select 'Pooling Of Saliva' Status")
        End If
        If ComboBox14.Text = "" Then
            ComboBox14.Text = InputBox("Select 'Impression' Status")
        End If
        If ComboBox15.Text = "" Then
            ComboBox15.Text = InputBox("Select 'Advice' Status")
        End If
        If IsNothing(PictureBox3.Image) Or IsNothing(PictureBox5.Image) Or IsNothing(PictureBox7.Image) Or IsNothing(PictureBox6.Image) Or IsNothing(PictureBox4.Image) Then
            ...
            MsgBox("Image is not inserted in any of the box. Please insert image and try again.")
        Else
            ...
            cmd.ExecuteNonQuery()
            con.Close()
            MessageBox.Show("Record saved", "Saving Status", MessageBoxButtons.OK, MessageBoxIcon.Information)
