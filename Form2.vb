Public Class Form2
    ...
    Private Sub Form2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Label1.Location = New Point(sw / 2 - 85, sh / 2 - 165)
        Me.Button2.Location = New Point(sw / 2 - 91, sh / 2 - 42)
        Me.Button3.Location = New Point(sw / 2 - 91, (sh / 2 - 85))
        Me.Button6.Location = New Point(sw / 2 - 91, (sh / 2 + 85))
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        pppnam = InputBox("Enter Patient's name")
        pupdate(pppnam)
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        ppname = InputBox("Enter Patient's Name")
